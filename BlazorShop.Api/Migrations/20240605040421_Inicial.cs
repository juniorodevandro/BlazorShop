        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconCSS = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "fa-keyboard", "Teclado" });

            migrationBuilder.InsertData(
                table: "Usuario",
                columns: new[] { "Id", "Nome" },
                values: new object[] { 1, "Evandro Junior" });

            migrationBuilder.InsertData(
                table: "Produto",
                columns: new[] { "Id", "CategoriaId", "Descricao", "ImagemUrl", "Nome", "Preco", "Quantidade" },
                values: new object[] { 1, 1, "Tem um design mais robusto e durável, além de ser projetado para suportar uma utilização intensa, mesmo durante longas sessões de jogos", null, "Teclado Gamer", 100m, 1 });
